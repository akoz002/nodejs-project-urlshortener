...
class VisitUrlForm extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("form", {
      action: 'api/shorturl/' + this.props.shortUrl,
      method: "GET",
      target: "_blank",
      onSubmit: this.visitUrl
    }, /*#__PURE__*/React.createElement("label", {
      for: "url-input"
    }, "Short URL to visit:"), /*#__PURE__*/React.createElement("input", {
      id: "url-input",
      type: "text",
...
const ConnectedVisitForm = ReactRedux.connect(state => ({
...
ReactDOM.render( /*#__PURE__*/React.createElement(ReactRedux.Provider, {
  store: store
}, /*#__PURE__*/React.createElement(ConnectedVisitForm, null)), document.querySelector('#visit-url-form'));